// Thin wrapper around ExtPay for extension pages (popup/options).
// When SNIPKEY_CONFIG.EXTPAY_ID is null the extension behaves as free-only
// and all upgrade UI stays hidden.
globalThis.SnipKeyPay = (() => {
  const id = globalThis.SNIPKEY_CONFIG.EXTPAY_ID;
