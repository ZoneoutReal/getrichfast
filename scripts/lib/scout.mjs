...
export function renderIssue(e) {
  ...
  return [
    `## Build candidate: ${e.name} (score ${e.score})`,
    "",
    e.pitch ? `> ${e.pitch}` : "",
    "",
    ...
    "- [ ] Clone the SnipKey factory structure into `products/" + (e.slug || "slug") + "/`",
    ...
    "- [ ] Release zip built and `node scripts/check-release.mjs " + (e.slug || "slug") + "` passes",
